...
// ---- enums from ardupilotmega/ardupilotmega.h ----
...
// ---- enums from csAirLink/csAirLink.h ----
...
// ---- enums from cubepilot/cubepilot.h ----
...
// ---- enums from development/development.h ----
...
// ---- enums from loweheiser/loweheiser.h ----
...
// ---- enums from python_array_test/python_array_test.h ----
...
// ---- enums from standard/standard.h ----
...
// ---- enums from stemstudios/stemstudios.h ----
...
/** @brief 
       ...
       */
#ifndef HAVE_ENUM_LED_CONFIG_MODE
#define HAVE_ENUM_LED_CONFIG_MODE
typedef enum LED_CONFIG_MODE
{
   LED_CONFIG_MODE_ALL=0, /* Set all LEDs in the target strip to the first color in our colors array. | */
   LED_CONFIG_MODE_INDEX=1, /* Set up to 8 consecutive LEDs, starting from the given index, to the colors provided in the colors array. | */
   LED_CONFIG_MODE_FOLLOW_FLIGHT_MODE=2, /* Set all LEDs in target strip to change color according to the flight mode. | */
   LED_CONFIG_MODE_CLEAR=3, /* Set all LEDs in the target strip to black (turn off). | */
   LED_CONFIG_MODE_ENUM_END=4, /*  | */
} LED_CONFIG_MODE;
#endif
...
// ---- enums from ualberta/ualberta.h ----
...
// ---- enums from uAvionix/uAvionix.h ----
